...
export class KeretaPage {
  ...
  OpenModalTujuan(obj) {
    let myModal = this.modalCtrl.create(TujuanStasiunModal);
  ...
  searchtrain() {
    this.navCtrl.push(KeretaSearchPage, {
...
@Component({
  templateUrl: 'tujuanstasiun.html'
})
export class TujuanStasiunModal {
...
export class KeretaSearchPage {
  constructor(public navCtrl: NavController, public navParams: NavParams, public modalCtrl: ModalController, public httpreq: HttpReqProvider) {
